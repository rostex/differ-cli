...
public class FormatterTest {
    ...
    public void beforeEach() {
        ...
        content4.add(new Data("chars1", new String[]{"a", "b", "c"}, new String[]{"a", "b", "c"}.toString(), Data.Status.UNCHANGED));
        ...
        content4.add(new Data("numbers1", new Integer[]{1, 2, 3, 4}, new Integer[]{1, 2, 3, 4}, Data.Status.UNCHANGED));
        content4.add(new Data("numbers2", new Integer[]{2, 3, 4, 5}, new Integer[]{22, 33, 44, 55}, Data.Status.UPDATED));
